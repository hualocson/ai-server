...
from aistron.modeling import GeneralizedRCNNAmodal
...
from utils.my_visualizer import AmodalVisualizer
...
class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.SEGMENTATION, parallel=False):
        ...
        """
        MetadataCatalog.get(cfg.DATASETS.TRAIN[0] ).thing_classes = ["crystal"]
    ...
    def run_on_image(self, image, segm_type='amodal'):
            ...
            if "panoptic_seg" in predictions:
                ...
                if "instances" in predictions:
                    ...
                    vis_output = visualizer.draw_amodal_instance_predictions(predictions=instances, segm_type=segm_type)
